use berthos_adapter_openai::{ComputerCall, actions_from_calls, computer_calls, outputs_from_ack};
use berthos_protocol::{Ack, AckKind, AckResult, Action, Button, Frame, FrameKind};
