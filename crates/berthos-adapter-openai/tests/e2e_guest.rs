...
use berthos_adapter_openai::{actions_from_calls, computer_calls, outputs_from_ack};
use berthos_node::SessionManager;
use berthos_protocol::{Class, Density, Isolation, LeaseRequest, License, Os, Resources, Term};
use serde_json::json;
...
#[tokio::test]
#[ignore = "requires Docker; BERTH_E2E=1 cargo test -p berthos-adapter-openai -- --ignored"]
